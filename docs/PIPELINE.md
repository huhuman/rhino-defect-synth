...
- long-running `main_cube_batch.py` runs can temporarily disable Rhino autosave and undo recording via `preparation.autosave.disable_during_batch` and `preparation.undo.disable_during_batch`
